...
void sws_getFlagsAndFilterFromCmdLine3d(int *flags, SwsFilter **srcFilterParam, SwsFilter **dstFilterParam);
...
static int config(struct vf_instance *vf,
	...
	if(scale3d_height < 0)
		scale3d_height = vf->priv->h;
	else
		vf->priv->h = scale3d_height;
...
void sws_getFlagsAndFilterFromCmdLine3d(int *flags, SwsFilter **srcFilterParam, SwsFilter **dstFilterParam)
{
        ...
        *flags=0;
        ...
        src_filter= sws_getDefaultFilter(0, 0, 0, 0, 0, 0, verbose>1);
...
const vf_info_t vf_info_scale3d = {
    "software scaling",
    "scale3d",
    "william0wang",
    "",
