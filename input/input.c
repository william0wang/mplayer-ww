...
static const mp_cmd_t mp_cmds[] = {
  ...
  { MP_CMD_GET_TIME_POS_EX, "get_time_pos_ex", 0, { {-1,{0}} } },
  ...
  { MP_CMD_GET_VIDEO_ASPECT, "get_video_aspect", 0, { {-1,{0}} } },
  ...
  { MP_CMD_SCREENSHOT_EX, "screenshotex", 1, { {MP_CMD_ARG_STRING,{0}}, {MP_CMD_ARG_INT,{0}}, {-1,{0}} } },
